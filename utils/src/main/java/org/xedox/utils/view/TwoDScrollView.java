...
// take from https://github.com/jaredrummler/TwoDScrollView.git //
 ...
 * within a larger container. Original source code from Matt Clark at:
...
public class TwoDScrollView extends FrameLayout {
     ...
     * or not.
     *
     * @param fillViewport True to stretch the content's height to the viewport's boundaries, false
     *     otherwise.
     * @attr ref android.R.styleable#ScrollView_fillViewport
     */
     ...
     * @param top the top offset of the bounds in which a focusable must be found (the fading edge
     *     is assumed to start at this position)
    ...
    private View findFocusableViewInMyBounds(
            boolean topFocus, int top, boolean leftFocus, int left, View preferredFocusable) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (top < viewBottom && viewTop < bottom && left < viewRight && viewLeft < right) {
                ...
                if (focusCandidate == null) {
                    ...
                    boolean viewIsCloserToVerticalBoundary =
                    ...
                    if (foundFullyContainedFocusable) {
                        if (viewIsFullyContained
                            ...
                            // We're dealing with only fully contained views, so it has to be closer
                            // to the
                        ...
                        if (viewIsFullyContained) {
                            ...
                            foundFullyContainedFocusable = true;
                                ...
                                && viewIsCloserToHorizontalBoundary) {
                            // Partially contained view beats another partially contained view if
                            // it's closer
                            focusCandidate = view;
                        }
                    }
     ...
     *
     * <p>This is more expensive than the default {@link ViewGroup} implementation, otherwise this
     * behavior might have been made the default.
     */
    @Override
    ...
    protected void measureChild(
        ...
        childWidthMeasureSpec =
                getChildMeasureSpec(
                        parentWidthMeasureSpec, getPaddingLeft() + getPaddingRight(), lp.width);
    ...
    public interface ScrollChangeListener {
        ...
        /**
         * This is called in response to an internal scroll in this view (i.e., the view scrolled
         * its own contents). This is typically as a result of {@link View#scrollBy(int, int)} or
         * {@link View#scrollTo(int, int)} having been called.
         *
