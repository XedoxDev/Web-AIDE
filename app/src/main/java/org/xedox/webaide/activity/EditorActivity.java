...
public class EditorActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setSubtitle(
                    project != null ? project.name : getString(R.string.app_name));
        }
        ...
        drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, 0, R.drawable.file_tree);
        ...
        drawerLayout.setOnTouchListener((view, ev) -> {
    ...
    private void showTabMenu(TabLayout.Tab tab, int position) {
        OverflowMenu.show(this, tab.view, R.menu.tab, item -> {
    ...
    public void updateMenu(boolean fv, boolean sv) {
        ...
        if (mdPreview != null) {
            ...
            boolean md = f != null && f.file != null && f.file.getName() != null
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.run) {
            ...
            startActivity(new Intent(this, MarkdownPreviewActivity.class)
                    .putExtra("text", getCurrentFragment().editorView.getText().toString()));
            return true;
        ...
        } else if (id == R.id.encode_tools) {
            EncodeToolsDialog.show(this);
            return true;
    ...
    private EditorFragment getCurrentFragment() {
        ...
        return (p >= 0 && p < editorAdapter.getFragments().size())
                ? editorAdapter.getFragments().get(p) : null;
    }
