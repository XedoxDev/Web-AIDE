...
public class SettingsActivity extends BaseActivity {
    ...
    public static void applyLocale(Context context) {
        ...
        String lang = prefs.getString("language_pref", "en");
    ...
    public static class GeneralFragment extends PreferenceFragmentCompat
        ...
        public void onCreatePreferences(Bundle extraArgs, String root) {
            ...
            MaterialListPreference languagePref = new MaterialListPreference(requireContext());
            languagePref.setKey("language_pref");
            languagePref.setTitle("Application language");
            languagePref.setSummary("Select language for the app");
            languagePref.setEntries(new CharSequence[] {"English", "Русский"});
            languagePref.setEntryValues(new CharSequence[] {"en", "ru"});
            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(requireContext());
            String currentLang = sp.getString("language_pref", "en");
            languagePref.setValue(currentLang);
            languagePref.setOnPreferenceChangeListener(
                    (preference, newValue) -> {
                        String lang = newValue.toString();
                        sp.edit().putString("language_pref", lang).apply();
